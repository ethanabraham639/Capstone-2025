...
// PCA9685_t led_pca9685 = {.addr = 0x47, .isLed = true, .osc_freq = 25000000.0};
// PCA9685_t servo_pca9685 = {.addr = 0x42, .isLed = false, .osc_freq = 25000000.0};
...
void app_main()
{
    vTaskDelay(2000 / portTICK_PERIOD_MS); // Delay for smooth motion
